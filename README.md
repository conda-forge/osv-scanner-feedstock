...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/osv-scanner-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/osv-scanner-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add osv-scanner
# for installing globally
pixi global install osv-scanner
```
...
It is possible to list all of the versions of `osv-scanner` available on your platform:
...
```
pixi search osv-scanner --channel conda-forge
```
